...
export class RegisterComponent implements OnInit {
  ...
  constructor(private fb:FormBuilder,private customValidator: CustomvalidatorsService,private regservice:RegisterserviceService){}
  ...
  ngOnInit(): void {
    ...
    onSubmit() {
      ...
      if (this.registerForm.valid) {
        ...
        this.regservice.sendData(data) .subscribe(data=>{
